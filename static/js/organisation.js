$(document).ready(function()
{
    ...
    /*tempData = {
        "tab0": {
            ...
            "tab 0 task 2": ["", "Never gonna give you up<br/>Les <strong>balises</strong> <em>HTML</em> fonctionnent"],
            "tab 0 task 3": ["", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"]
        },

        "tab1": {
            "task1-0": ["checked", "YAHOOOOO"],
            "task1-1": ["checked", "OK"],
        ...
        "tab2": {
            ...
            "task2-3": ["checked", "yuiyuiyuityuiyuiuiyui"],
            "task2-4": ["", "vxccvzxcvzxcvzcxvxcv"],
            "task2-5": ["", "hgfhfdhdfghfhdfghgfh"],
            "task2-6": ["", "ewfppwefwepof"],
            "the really long boi": ["", "hgfh fdhdf ghfh dfghgfh hgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfhhgfh fdhdf ghfh dfghgfh"]
        },
    ...
    document.getElementById("chatMinimize").addEventListener("click", function() {
        ...
        {
            chat.toggleClass("chatMinSize");
            chat.animate({ "height": "40", "width": "160" }, 600, function() {
                $("#chatMinimize").text('➕');
                $('#chatBody').hide();
            });
        }
...
function loadTab(tabId) {
    ...
    Object.keys(tempData[tabId]).forEach(task => {
        ...
        taskChkbox.checked = tempData[tabId][task]["checked"];
...
function loadDetails(tabId, taskId) {
    document.getElementById("details").innerHTML = "<h2>" + taskId + "</h2><br/>" + tempData[tabId][taskId]["desc"];
}
...
socket.on('setCheckState', function(dicChange) 
{
    ...
    tempData[tabId][taskId]["checked"] = checked;
